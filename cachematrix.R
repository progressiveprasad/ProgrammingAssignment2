...
## of the original matrix reamaining unchanged, then the cached matrix is retrieved and the message
## "getting cached matrix" is displayed. This is achieved the <<- operator which keeps
